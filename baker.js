...
(function(root, factory) {
    if(typeof define === 'function' && define.amd) {
        define(['et209'], factory);
    }
    else if(typeof module === 'object' && module.exports) {
        module.exports = factory(require('et209'));
    }
    else {
        root.bakeArsTrackerSong = factory(root.ET209);
    }
}(typeof self !== 'undefined' ? self : this, function(ET209) {
    var bakeArsTrackerSong;
    {
        ...
        InstrumentState.prototype.frobVoice = function frobVoice(et209, channel, volume, hwslide, pan) {
            ...
            if(freq >= 16384) {
                // The bent pitch is either strongly negative or strongly
                // positive. We guess which using the same method the real
        ...
        // - loopOverlapTime (seconds, default 2): If looping, the amount of
        // extra time to add to make sure the loop is clean.
        // - loopFadeTime (seconds, default 5): If looping, the amount of extra
        // time to add to the end, so it can fade out nicely if you don't use
        // the looping information.
        // - startOrder (index, default 0): The order index to start at. When
        // in doubt, leave unset.
        // - headphones (boolean, default false): Whether to enable the
        // "headphones filter".
        //
        ///////////////////////////////////////////////////////////////////////
        let PlaybackState = function PlaybackState(module, song, options) {
            ...
            for(var n = 0; n < NOISE_CHANNEL_INDEX; ++n) {
                this.channels[n] = {"slide":0, "pan":0, "volume":15,
                                    "instrument":null};
            }
